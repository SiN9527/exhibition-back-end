...
public class JwtUtil {
     ...
     */
    public static String extractUserType(String token, SecretKey secretKey) {
        return extractClaim(token, claims -> claims.get("type", String.class),secretKey);  // **提取 USER / MEMBER**
    }
